...
**Week 04**: 
- [![Open in PDF](https://img.shields.io/badge/-PDF-EC1C24?style=flat-square&logo=adobeacrobatreader)](https://github.com/ivanovitchm/datastructure/tree/main/lessons/week_04/week_03.pdf) **Data Structure Preliminaries:** recursion, binary tree and search tree.
    ...
    - :hourglass_flowing_sand: Estimated time: 3h
    - Suggested courses
        - Overview of recursion [![Open in Dataquest](https://app.dataquest.io/c/109/m/578)
        - Introduction to binary trees [![Open in Dataquest](https://app.dataquest.io/c/109/m/579)
    Code interview challenge and co-creation using Large Language Model (LLM) and ChatGPT. 
